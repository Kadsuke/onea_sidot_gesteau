...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "modeevacuationeauusee")
public class ModeEvacuationEauUsee implements Serializable {
    ...
    public ModeEvacuationEauUsee id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public ModeEvacuationEauUsee ficheSuiviOuvrages(Set<FicheSuiviOuvrage> ficheSuiviOuvrages) {
        this.setFicheSuiviOuvrages(ficheSuiviOuvrages);
        return this;
    }

    public ModeEvacuationEauUsee addFicheSuiviOuvrage(FicheSuiviOuvrage ficheSuiviOuvrage) {
        this.ficheSuiviOuvrages.add(ficheSuiviOuvrage);
        ficheSuiviOuvrage.setModeevacuationeauusee(this);
        return this;
    }

    public ModeEvacuationEauUsee removeFicheSuiviOuvrage(FicheSuiviOuvrage ficheSuiviOuvrage) {
        this.ficheSuiviOuvrages.remove(ficheSuiviOuvrage);
        ficheSuiviOuvrage.setModeevacuationeauusee(null);
        return this;
    }

    public void setFicheSuiviOuvrages(Set<FicheSuiviOuvrage> ficheSuiviOuvrages) {
        if (this.ficheSuiviOuvrages != null) {
            this.ficheSuiviOuvrages.forEach(i -> i.setModeevacuationeauusee(null));
        }
        if (ficheSuiviOuvrages != null) {
            ficheSuiviOuvrages.forEach(i -> i.setModeevacuationeauusee(this));
        }
