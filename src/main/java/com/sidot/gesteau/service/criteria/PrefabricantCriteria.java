...
/**
 * Criteria class for the {@link com.sidot.gesteau.domain.Prefabricant} entity. This class is used
 * in {@link com.sidot.gesteau.web.rest.PrefabricantResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /prefabricants?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class PrefabricantCriteria implements Serializable, Criteria {
    ...
    public PrefabricantCriteria() {}

    public PrefabricantCriteria(PrefabricantCriteria other) {
    ...
    @Override
    public PrefabricantCriteria copy() {
        return new PrefabricantCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final PrefabricantCriteria that = (PrefabricantCriteria) o;
        return (
