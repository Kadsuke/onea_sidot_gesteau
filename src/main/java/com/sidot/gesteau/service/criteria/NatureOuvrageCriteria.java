...
/**
 * Criteria class for the {@link com.sidot.gesteau.domain.NatureOuvrage} entity. This class is used
 * in {@link com.sidot.gesteau.web.rest.NatureOuvrageResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /nature-ouvrages?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class NatureOuvrageCriteria implements Serializable, Criteria {
    ...
    public NatureOuvrageCriteria() {}

    public NatureOuvrageCriteria(NatureOuvrageCriteria other) {
    ...
    @Override
    public NatureOuvrageCriteria copy() {
        return new NatureOuvrageCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NatureOuvrageCriteria that = (NatureOuvrageCriteria) o;
        return (
