...
/**
 * Criteria class for the {@link com.sidot.gesteau.domain.ModeEvacExcreta} entity. This class is used
 * in {@link com.sidot.gesteau.web.rest.ModeEvacExcretaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /mode-evac-excretas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ModeEvacExcretaCriteria implements Serializable, Criteria {
    ...
    public ModeEvacExcretaCriteria() {}

    public ModeEvacExcretaCriteria(ModeEvacExcretaCriteria other) {
    ...
    @Override
    public ModeEvacExcretaCriteria copy() {
        return new ModeEvacExcretaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ModeEvacExcretaCriteria that = (ModeEvacExcretaCriteria) o;
        return (
    ...
    public String toString() {
        return "ModeEvacExcretaCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
