...
/**
 * Criteria class for the {@link com.sidot.gesteau.domain.Macon} entity. This class is used
 * in {@link com.sidot.gesteau.web.rest.MaconResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /macons?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MaconCriteria implements Serializable, Criteria {
    ...
    public MaconCriteria() {}

    public MaconCriteria(MaconCriteria other) {
    ...
    @Override
    public MaconCriteria copy() {
        return new MaconCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MaconCriteria that = (MaconCriteria) o;
        return (
